...
function refreshDetalleRev() {
  ...
  if (rows.length === 0) {
    ...
    rows.forEach(r => {
      ...
      h += '<tr>'
        + `<td class="td-mono" style="font-size:12px"><a href="#" class="codigo-link" onclick="document.getElementById('filterSearch').value='${r.code}';refresh();return false" title="Filtrar por esta actividad"><b>${r.code}</b> <span style="font-weight:400">${r.desc}</span></a></td>`
